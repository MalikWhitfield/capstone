    ...
    <div class="card" style="width: 16rem;">
      ...
      <div class="card-body">
        <div class="d-flex justify-content-end" v-if="user._id && viewedUser._id == user._id">
          <i class="fas fa-user-edit hover" @click="showEditUser = !showEditUser"></i>
          <i class="fas fa-atom ml-2 mb-1 hover" @click="showAddHobbi = !showAddHobbi"></i>
        </div>
        <h5 class="card-title">
          <strong>{{ viewedUser.name ||user.name }}</strong>
        </h5>
